...
<script>
import { ColumnSeries, Category, Legend, Selection } from "@syncfusion/ej2-vue-charts";

export default {
  name: 'MultipleColumnSeries',
  props: [],
  computed: {
    propFilteredSeriesArray() {
      return this.seriesData.map(data => data);
    }
  },
  data() {
    return {
